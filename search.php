...
<section class="pa-search">
  <div class="container">
    <div class="row">
      <div class="col">
        <header class="my-5">
          <h1 class="h2"><?= _e('Results for:', 'iasd'); ?> <b><?php echo htmlspecialchars(isset($_GET['q'])? $_GET['q'] : ''); ?></b></h1>
          <form method="get" action="<?php echo site_url(); ?>/busca/?" class="search_form">
            <div class="input-group mt-4">
              <input type="text" name="q" class="form-control" value="<?php echo htmlspecialchars(isset($_GET['q'])? $_GET['q'] : ''); ?>">
