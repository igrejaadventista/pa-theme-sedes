					...
					<footer class="row">
						<div class="col d-flex flex-column justify-content-xl-between">
							<div class="d-flex flex-column align-items-center align-items-xl-start px-5 px-xl-0">
								<div class="pa-brand">
									<a href="/" title="Igreja Adventista do Sétimo Dia"><img src="<?= get_stylesheet_directory_uri() . "/assets/imgs/pt-br/logo-iasd-vertical.svg" ?>" alt="Igreja Adventista do Sétimo Dia" title="Igreja Adventista do Sétimo Dia" class="img-fluid"></a>
