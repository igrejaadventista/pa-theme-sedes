			...
			<div class="glide__track" data-glide-el="track">
				<div class="glide__slides">
					<div class="glide__slide">
						...
						<h3 class="card-title font-weight-bold h5 mt-4 pa-truncating-1">Fim de semana da família</h3>
						<p class="card-text pa-truncating-2">Mais de 15 mil líderes e servidores da Igreja acompanharam a programação em diversas regiões do Planeta</p>
					</div>
					<div class="glide__slide">
						<img class="rounded img-fluid" src="https://picsum.photos/336/390.webp?random=2"  alt="" >
						<h3 class="card-title font-weight-bold h5 mt-4 pa-truncating-1">Fim de semana da família</h3>
						<p class="card-text pa-truncating-2">Com o auxílio da ADRA e outras instituições, os refugiados recebem oportunidades para conquistar autonomia financeira e oportunidade</p>
					</div>
					<div class="glide__slide">
						<img class="rounded img-fluid" src="https://picsum.photos/336/390.webp?random=3"  alt="" >
						<h3 class="card-title font-weight-bold h5 mt-4 pa-truncating-1">Fim de semana da família</h3>
						<p class="card-text pa-truncating-2">Novo livro busca na observação da natureza a base para o diálogo entre as duas áreas</p>
					</div>
					<div class="glide__slide">
						<img class="rounded img-fluid" src="https://picsum.photos/336/390.webp?random=4"  alt="" >
						<h3 class="card-title font-weight-bold h5 mt-4 pa-truncating-1">Fim de semana da família</h3>
						<p class="card-text pa-truncating-2">Teólogo Elias Brasil de Souza, que dirige o Instituto de Pesquisas Bíblicas da Igreja Adventista do Sétimo Dia, explica  conceitos</p>
					</div>
					<div class="glide__slide">
						<img class="rounded img-fluid" src="https://picsum.photos/336/390.webp?random=5"  alt="" >
						<h3 class="card-title font-weight-bold h5 mt-4 pa-truncating-1">Fim de semana da família</h3>
						<p class="card-text pa-truncating-2">Presidente mundial da denominação pede orações por todas as pessoas afetadas pela tragédia</p>
					</div>				
				</div>
			</div>
