			...
			<div class="glide__track" data-glide-el="track">
				<div class="glide__slides">
					<div class="glide__slide">
						...
						<h3 class="card-title font-weight-bold h5 mt-4">Fim de semana da família</h3>
						<p class="card-text">Acompanhe uma maratona de conteúdos exclusivos sobre família, casamento...</p>
					</div>
					<div class="glide__slide">
