...
### Fixed
- Ajustar lógica de exibição (ADVC-207)

## [2.2.0] - 2026-02-05

### Fixed
- Correção na lógica de carregamento do banner e do footer.
- Ajuste na validação do site de notícias ao criar novos posts na seção Imprensa. 

## [2.1.0] - 2025-02-15

### Added

- Adicionar option de autoplay do banner
- Alterar exibição do setting

## [2.0.0] - 2025-02-XX

### Changed

- Auto play nos Slides principais 
