@if(is_admin())
	<img class="img-preview" src="{{ get_template_directory_uri() }}/Blocks/PACarouselFeature/preview.png" alt="Imagem ilustrativa do front-end da widgets PA Carousel Feature"/>
@else
