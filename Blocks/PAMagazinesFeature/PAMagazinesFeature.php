...
namespace Blocks\PAMagazinesFeature;
...
/**
 * PAMagazinesFeature Magazines feature block
 */
class PAMagazinesFeature extends Block {

    public function __construct() {
		// Set block settings
        parent::__construct([
            'title' 	  => 'IASD - Carousel - Magazines',
            'description' => 'Acervo de revistas',
