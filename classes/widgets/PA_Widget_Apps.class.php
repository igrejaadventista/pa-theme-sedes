...
class WPDocs_New_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct( false, __( 'IASD - Widgets', 'iasd' ) );
    }
    ...
    public function form( $instance ) {
		...
		$title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Novo widget', 'iasd' );
		...
		?>
		<p>
			<label for="<?= esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_attr_e( 'Title:', 'iasd' ); ?></label> 
			<input class="widefat" id="<?= esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?= esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?= esc_attr( $title ); ?>">
		</p>
		<div>
			<p>
				<label for="<?= $this->get_field_id('widget-file'); ?>"><?= _e( 'Widget:', 'iasd'); ?></label>
		...
		<div id="widget-size">
			<p>
				<label for="<?= $this->get_field_id('widget-size'); ?>"><?= _e( 'Widget size:', 'iasd'); ?></label>
