		...
		<div>
			<p>
				...
				<select name="<?= $this->get_field_name('widget-file'); ?>" id="<?= $this->get_field_id('widget-file'); ?>" class="widefat" onchange="checkValue('<?= $this->get_field_id('') ?>');">
					...
					<option value="pa-feliz7play.php"<?php selected( $instance['widget-file'], 'pa-feliz7play.php' ); ?>>Widget - Feliz7Play</option>
					<option value="pa-find-church.php"<?php selected( $instance['widget-file'], 'pa-find-church.php' ); ?>>Widget - Find Church</option>
				</select>
			</p>
		</div>
		<div id="widget-size">
